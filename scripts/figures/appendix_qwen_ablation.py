...
MODELS = ["qwen3_4b", "qwen3_8b", "qwen3_14b"]
COLORS = ["#0173b2", "#56b4e9", "#029e73"]
...
df_gpqa = pd.read_parquet(
    "../../results/processed_ablation_outputs.parquet",
    columns=cols,
    filters=[("dataset", "==", "gpqa")],
)
df_mmlu = pd.read_parquet(
    "../../results/processed_ablation_outputs.parquet",
    columns=cols,
...
ax1["E"].set(xlim=(0, 100), ylim=(0, 0.48))
...
ax1["F"].set(xlim=(0, 100), ylim=(0, 0.48))
...
ax1["G"].set(xlim=(0, 100), ylim=(0, 0.36))
...
ax1["H"].set(xlim=(0, 100), ylim=(0, 0.36))
...
Figure1.savefig("../../results/figures/appendix_qwen_ablation.png", dpi=300, bbox_inches="tight")
